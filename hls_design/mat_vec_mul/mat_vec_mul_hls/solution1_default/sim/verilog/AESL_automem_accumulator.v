...
module AESL_automem_accumulator (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.mat_vec_multiply.autotvin_accumulator.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.mat_vec_multiply.autotvout_accumulator.dat"; 
//------------------------Local signal-------------------
