...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mat_vec_multiply.autotvin_mat_in.dat"
         "c.mat_vec_multiply.autotvin_vec_in.dat"
         "c.mat_vec_multiply.autotvin_accumulator.dat"
         "c.mat_vec_multiply.autotvout_accumulator.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mat_vec_multiply.autotvout_accumulator.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
