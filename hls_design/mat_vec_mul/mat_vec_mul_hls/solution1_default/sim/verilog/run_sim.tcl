...
if {[file isfile mat_vec_multiply.autotvin.dat]} {
	file delete -force mat_vec_multiply.autotvin.dat
}

if {[file isfile mat_vec_multiply.autotvout.dat]} {
	file delete -force mat_vec_multiply.autotvout.dat
}
