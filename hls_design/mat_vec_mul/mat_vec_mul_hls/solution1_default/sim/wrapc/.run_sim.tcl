...
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/Vivado2020/Vivado/2020.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);E:/Vivado2020/Vivado/2020.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/Vivado2020/Vivado/2020.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Vivado2020/Vivado/2020.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mat_vec_multiply.autotvin.dat"
	set constFileTvOut       "mat_vec_multiply.autotvout.dat"
	set constFileHdlTvIn     "mat_vec_multiply.autohdltvin.dat"
	set constFileHdlTvOut    "mat_vec_multiply.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
